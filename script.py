...
logging.info(Fore.WHITE + 'INICIANDO SCRIPT... 		ver. 2016.11.22' + Fore.WHITE)
	...
	for row3 in rows3:
		...
		if ping_b==True:
			...
			try:
				...
				logging.error(Fore.MAGENTA + Back.CYAN + "HTTP ERRORR... CODE:" + str(f.getcode()) + Fore.WHITE)
			except urllib.error.URLError as e:
				logging.error(Fore.MAGENTA + Back.CYAN + "URl ERROR... CODE:"+ str(e) + Fore.WHITE)
			else:
				...
				satrtCorriente = "Corriente = "
				startNumeroSerie_ = "MAC = "
				...
				logging.debug(Fore.CYAN + "HTML FUENTE 5v:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML FUENTE 24v:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML FUENTE PPIC:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML FUENTE 5PIC:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML CORRIENTE:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML MAC:" + htmlTemp_s + Fore.WHITE)
				...
				logging.debug(Fore.CYAN + "HTML MENSAJE:" + htmlTemp_s + Fore.WHITE)
